...
{
    public abstract class SingletonPool<T> : SingletonMono<SingletonPool<T>>, IPool<T> where T : class
    {
        ...
        protected override void OnInstanceCreate(SingletonPool<T> instance) { }
